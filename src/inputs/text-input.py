...
async def main():
    async with async_playwright() as p:
        ...
        await expect(page.locator("p#currentAddress")).to_have_text(
            "Current Address :myAddress"
        )
        await expect(page.locator("p#permanentAddress")).to_have_text(
            "Permananet Address :myPermanentAddress"
        )
        # -Stoping Tracing
